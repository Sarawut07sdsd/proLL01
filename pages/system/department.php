    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xl-6 grid-margin stretch-card flex-column">
                <h5 class="mb-2 text-titlecase mb-4">ข้อมูลแผนก</h5>
            </div>
        </div>
                        ...
                        <table style="" class="table table-striped project-orders-table">
                            ...
                            <tbody>
                                ...
                                <form class="forms-sample" action="./api/api_system.php" method="POST">
                                    ...
                                    <td><input type="text" class="form-control" name="Dep_id" id="Dep_id4" placeholder="รหัสแผนก" require>  </td>
                                    <td> <input type="text" class="form-control" name="Dep_name" id="Dep_name" placeholder="ชื่อแผนก" require> </td>
