...
<div class="main-panel">
    <div class="content-wrapper">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="./api/api_system.php?str=deleteEmployee&str2=employeeHR&Emp_id=<?php echo $ShowmployeetHR['Emp_id']; ?>" onclick="return confirm('คุณแน่ใจว่าจะลบข้อมูลใช่หรือไม่');" type="button" class="btn btn-danger btn-sm btn-icon-text">
                                                    ลบ
        ...
        <center>
            <h5 class="mb-2 text-titlecase mb-4" id="buttonY">เพิ่มข้อมูลหัวหน้าฝ่าย</h5>
            <div class="card-body col-md-6">
                <form class="forms-sample" action="./api/api_system.php" method="POST">
                    <div class="form-row">
                        ...
                        <input type="hidden" class="form-control" name="str2" id="str2" value="employeeHR">
